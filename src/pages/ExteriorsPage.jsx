...
const ExteriorsPage = () => {
  ...
  useEffect(() => {
    const fetchExteriors = async () => {
      try {
        // Fetch all exteriors and filter in JS to avoid index requirement for simple isActive check
        ...
        <div className="max-w-4xl mb-24">
          <Reveal>
            ...
            <h2 className="font-serif text-5xl md:text-7xl leading-[1.1] text-neutral-800">
              Modern facades that <br />
              <span className="italic text-stone-400 font-light">define architecture.</span>
            </h2>
          </Reveal>
        </div>

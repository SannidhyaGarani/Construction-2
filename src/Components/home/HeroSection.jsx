...
        >
          {/* Note: If this specific link fails, it's a Pixabay hotlinking restriction */}
          <source 
            src="videos/hero.mp4" 
            type="video/mp4" 
          />
        </video>
        {/* Architectural Scrim/Overlay - DARKER OVERLAY */}
        <div className="absolute inset-0 bg-black/60" />
        {/* Removed the white gradient on the bottom */}
      </div>
